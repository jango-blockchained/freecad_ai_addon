...
from .base_agent import (
    BaseAgent, AgentTask, TaskResult, TaskStatus, TaskType
)
...
class TaskPlanner:
    ...
    def parse_natural_language_request(self, request: str, context: Dict[str, Any] = None) -> ExecutionPlan:
        """
    ...
    def execute_autonomous_task(self, description: str, context: Dict[str, Any] = None) -> Dict[str, TaskResult]:
        """
    ...
    def _analyze_request(self, request: str, context: Dict[str, Any] = None) -> List[Dict[str, Any]]:
        """
        ...
        elif "boolean" in request_lower or "union" in request_lower or "difference" in request_lower:
    ...
    def _parse_create_box_request(self, request: str, context: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _parse_create_cylinder_request(self, request: str, context: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _parse_create_sphere_request(self, request: str, context: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _parse_fillet_request(self, request: str, context: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _parse_chamfer_request(self, request: str, context: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _parse_sketch_request(self, request: str, context: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        if "rectangle" in request.lower():
            operations.append({
                ...
                'priority': 2,
                'dependencies': [operations[0]['task_id'] if 'task_id' in operations[0] else None]
            })
        
        return operations
    
    def _parse_analysis_request(self, request: str, context: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _parse_boolean_request(self, request: str, context: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _match_templates(self, request: str, context: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        return {
            'create_basic_part': {
                ...
                'tasks': [
                    ...
                    {'type': TaskType.SKETCH_MODIFICATION, 'operation': 'add_rectangle'},
