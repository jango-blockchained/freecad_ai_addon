...
class ActionLibrary:
    ...
    def __init__(self):
        ...
        self.logger.info(
            "Action Library initialized with %d operations", len(self.feature_registry)
        )
    ...
    def boolean_difference(
        self, base: str, tool: str, name: str = "Difference"
    ) -> Dict[str, Any]:
        """
    ...
    def boolean_intersection(
        self, objects: List[str], name: str = "Intersection"
    ) -> Dict[str, Any]:
        """
    ...
    def get_bounding_box(self, obj_name: str) -> Dict[str, Any]:
        ...
        bbox_dict.update(
            {"object_name": obj_name, "units": "mm", "measurement_type": "bounding_box"}
        )
    ...
    def create_sweep(
        self, profile_sketch: str, path_sketch: str, name: str = "Sweep"
    ) -> Dict[str, Any]:
    ...
    def create_shell(
        self, obj_name: str, faces: List[int], thickness: float, name: str = "Shell"
    ) -> Dict[str, Any]:
    ...
    def add_thickness(
        self, obj_name: str, thickness: float, name: str = "Thickness"
    ) -> Dict[str, Any]:
    ...
    def create_mirror(
        self, obj_name: str, plane: str, name: str = "Mirror"
    ) -> Dict[str, Any]:
